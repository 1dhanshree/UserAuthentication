...
def create_canvas(window):
    ...
    img2 = img2.resize((90, 60), PIL.Image.Resampling.LANCZOS)
    ...
    img3 = img3.resize((90, 60), PIL.Image.Resampling.LANCZOS)
    ...
    img4 = img4.resize((90, 60), PIL.Image.Resampling.LANCZOS)
