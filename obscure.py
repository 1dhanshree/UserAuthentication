    ...
    while True:
        ...
        with sr.Microphone() as source:  # setting microphone as default input device
            try:
                ...
                input_text = e.recognize_google_cloud(audio)  # Recognizes text using speech recognition
...
def start(window):
    ...
    img = img.resize((450, 300), PIL.Image.Resampling.LANCZOS)
    ...
    img2 = img2.resize((200, 170), PIL.Image.Resampling.LANCZOS)
