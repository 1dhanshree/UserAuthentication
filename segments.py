...
def start(window):
    ...
    img = img.resize((300, 250), PIL.Image.Resampling.LANCZOS)
    ...
    img2 = img2.resize((200, 150), PIL.Image.Resampling.LANCZOS)
    ...
    img3 = img3.resize((200, 150), PIL.Image.Resampling.LANCZOS)
    ...
    img4 = img4.resize((200, 150), PIL.Image.Resampling.LANCZOS)
    ...
    img5 = img5.resize((200, 150), PIL.Image.Resampling.LANCZOS)
